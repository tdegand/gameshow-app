    ...
    */
    createPhrases() {
        const phrases = [
            ...
            new Phrase('Devils advocate'),
            new Phrase('Has the cat got your tongue'),
            new Phrase('Havent got a clue'),
            new Phrase('Head over heels'),
            new Phrase('High and mighty'),
            new Phrase('Never look a gift horse in the mouth'),
            new Phrase('Never never land'),
            new Phrase('Just in the nick of time'),
            new Phrase('Make a bee-line for it'),
            new Phrase('Make my day'),
            new Phrase('Merry Christmas'),
            new Phrase('More bang for your buck'),
            new Phrase('Mumbo jumbo'),
            new Phrase('My way or the highway'),
            new Phrase('You are what you eat'),
            new Phrase('Your days are numbered'),
        ];
        return phrases;
    }
    /**
